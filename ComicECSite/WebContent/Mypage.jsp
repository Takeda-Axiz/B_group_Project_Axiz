...
ポイント数　<font color="red">10pt</font>
					...
					<form action="Index.html" class="pull-right">
						<input class="btn btn-primary btn-sm active" id="setLogin"
							...
							onclick= "location.href='Index02.html'; return false;">
							</form>
		...
		<section class="container">
			<section class="row">
				<div class="col-lg-12" style="margin-top: 23px;">
					<a class="btn btn-primary btn-md" href="BookSelect.html">my本棚ページ</a>
				</div>
			</section>
			<section class="row">
				<div class="col-xs-12" style="margin-top: 23px;">
					<a class="btn btn-primary btn-md" href="Charge.html" roll="btn">チャージ</a>
				</div>
			</section>
			<section class="row">
				<div class="col-xs-12" style="margin-top: 23px;">
					<a class="btn btn-primary btn-md" href="EditAccount.html" roll="btn">会員情報変更</a>
				</div>
			</section>
			<section class="row">
				<div class="col-xs-12" style="margin-top: 23px;">
					<a class="btn btn-primary btn-md" href="UserLeave.html" roll="btn">退会</a>
				</div>
			</section>
		</section>
	</section>
	...
	<section id="footer">
		<section class="container">
			<section class="row">
				...
				<div class="col-xs-2 col-md-1 col-xs-offset-8 col-md-offset-10">
					<a class="btn btn-primary btn-xs" href="mailto:info@example.com?
