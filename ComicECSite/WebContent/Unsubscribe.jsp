	...
	<section id="banner">
        ...
        <h3>強制退会</h3>
          <p>強制退会させたい会員のメールアドレスを入力して下さい。</p>
            <form action="administratorConfirm.html" method="post">
             <div>
             <label class="required">会員ID</label><input type="text" name="user_id">
             <button type="submit" class="btn btn-default" name="signup" onclick="location.href='UnsubscribeConfirm.html'; return false;">確認</button>
             </div>
            </form>
            <div>
            <a href="AdminTop.html">管理者ページに戻る</a>
            </div>
