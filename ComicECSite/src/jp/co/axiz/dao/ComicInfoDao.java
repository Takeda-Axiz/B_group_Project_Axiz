...
public class ComicInfoDao {
	...
	public void insert(String title, String numberOfTurns, String category,
			Integer price, String publisher, String imgPath, Date releaseDate,
		...
		try (PreparedStatement stmt = connection.prepareStatement
			...
			stmt.setString(3, introduction);	// 9
			stmt.setString(4, category);		// 3
			stmt.setInt(5, price);				// 4
			stmt.setString(6, publisher);		// 5
			stmt.setDate(7, releaseDate);		// 7
			stmt.setString(8, author);			// 8
			stmt.setString(9, imgPath);			// 6
			stmt.setString(10, imgPath);		// 6
			stmt.setString(11, timeStamp);		// 10
	 ...
	 * @return
	 */
	public void updateComicInfo(Integer comicId, String title, String numberOfTurns,
			String category, Integer price, String publisher, String imgPath,
			Date releaseDate, String author, String introduction, String timeStamp) {
		// 変数宣言
		// 初期化
		...
		try (PreparedStatement stmt = connection.prepareStatement
			...
			stmt.setString(2, numberOfTurns);	// 3
...
//	 * @return
//	 */
//	public void updateEvaluation(Integer comicId, String title, String numberOfTurns,
//			String category, Integer price, String publisher, String imgPath,
//			Date releaseDate, String author, String introduction, String timeStamp) {
//		// 変数宣言
//		// 初期化
