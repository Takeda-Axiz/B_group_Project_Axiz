...
<div class="a">
	<input type="button"  class="btn btn-primary" value="トップページ" onclick="location.href='Index.html'; return false;"><br>
	<br>
	<input type="button"  class="btn btn-primary" value="マイページ" onclick="location.href='MyPage.html'; return false;">
</div>
		<!-- All the scripts -->
