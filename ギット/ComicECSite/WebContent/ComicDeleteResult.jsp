...
<p><h3>正常にデータを削除しました</h3></p>
<a href="AdminReference.html"><input type="submit" class="btn btn-primary btn-md" value="登録漫画一覧"></a>
<a href="AdminTop.html"><input type="submit" class="btn btn-primary btn-md" value="管理者ページ"></a>
