			...
			<section class="row">
				...
				<form action="ComicInsertResult.html" method="post">
					<fieldset class="label-60">
						...
						<div>
							<label for="inputEmail3" class="col-xs-2 control-label">※表示画像</label><input type="text" name="evaluation" placeholder="Path" value="gazou/dg.jsp" readonly>
						</div>
						<div>
					...
					<div>
						...
						<input class="btn btn-primary btn-md" type="submit" name="button" onclick="location.href='ComicInsert.html'; return false;" value="漫画登録ページへ戻る">
					</div>
				</form>
			</section>
			<section class="row">
