		...
		<section class="container">
			<section class="row">
				<div class="col-lg-12" style="margin-top: 23px;">
					<a class="btn btn-primary btn-md" href="BookSelect.jsp">my本棚ページ</a>
				</div>
			</section>
			<section class="row">
				<div class="col-xs-12" style="margin-top: 23px;">
					<a class="btn btn-primary btn-md" href="Charge.jsp" roll="btn">チャージ</a>
				</div>
			</section>
			<section class="row">
				<div class="col-xs-12" style="margin-top: 23px;">
					<a class="btn btn-primary btn-md" href="EditAccount.jsp" roll="btn">会員情報変更</a>
				</div>
			</section>
			<section class="row">
				<div class="col-xs-12" style="margin-top: 23px;">
					<a class="btn btn-primary btn-md" href="UserLeave.jsp" roll="btn">退会</a>
				</div>
			</section>
		</section>
	</section>
		...
		<section class="container">
			<section class="row">
				<div class="col-xs-2 col-md-1">
					<a class="btn btn-primary btn-xs" href="index.html" roll="btn">TOPページ</a>
				</div>
